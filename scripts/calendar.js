...
var headbg = '#4284ce';  // table heading background ur
var todaybg = '#8ae0f8'; // current selected date background colour
...
function dispCal(yy,mm) 
{
	...
	if (mm > 0) 
		...
		var hilite_start = '<td width="27" style="background:' + todaybg + ';font:12px arial" align="center"><b>'; 
		//var td_start = '<td width="27" align="center">'; 
		var td_start = '<td width="27" align="center" style ="font:12px arial">'; 
		var cal = '<div id="cal"><div style="border:1pt  solid #cccccc;width:190px"><table border="0" cellspacing="0" cellpadding="1" align="center"><tr><td colspan="7" style="background:' + headbg + ';font:12px tahoma, arial; text-transform:uppercase; color:#ffffff;" align="center" ><b>' + moy[month]  + ' ' + year + '<\/b><\/td><\/tr><tr bgcolor="#f2efef">'; 
		for(dex=0; dex < 7; dex++) 
		{
		...
		if (document.getElementById) 
		{
			...
			var yb = yy -1; 
			var ya = yy +1; 
			cal += '<table border="0" cellspacing="0" cellpadding="1" width="190px"><tr><td><a href="#" onclick="if (cala = dispCal('+yb+','+mm+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}"><<</a></td><td><a href="#" onclick="if (cala = dispCal('+yyb+','+mmb+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}"><</a></td><td align="right"><a href="#" onclick="if (cala = dispCal('+yya+','+mma+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}">></a></td><td align="right"><a href="#" onclick="if (cala = dispCal('+ya+','+mm+')) {document.getElementById(\'cal\').innerHTML = cala; return false;}">>></a></td></tr></table>';
		} 
		else 
		{
			cal += '<div> </div>';
...
function start() 
{
	var x = '<div id="calDate" style="border:1pt solid #cccccc;width:190px"><\/div>'; 
	var y = ''; 
	if (tb == 't') 
		y = x + dispCal(0,0); 
	else 
